...
require_once __DIR__ . "/projet-horaires/Config/dotenv.php";
(new DotEnv(__DIR__ . "/projet-horaires/.env"))->load();

require_once __DIR__ . "/projet-horaires/Config/database.php";

include_once __DIR__ . "/projet-horaires/router.php";

include_once __DIR__ . "/projet-horaires/Controllers/HomeController.php";
